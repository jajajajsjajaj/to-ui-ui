...
class OutdatedSubState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.B || addVirtualPad.buttonB.justPressed && FlxG.save.data.begin_thing != true)
		{
		...
		if (FlxG.keys.justPressed.X || addVirtualPad.buttonX.justPressed && FlxG.save.data.begin_thing != true)
		{
			FlxG.save.data.begin_thing = true;
